# expert: cap_cwebp_to_webp_batch
# description: В WebP — Картинки в лёгкий формат WebP для сайтов — пачкой, локально Пакетно: операция «В WebP» ко всем подходящим файлам в папке. Локально/офлайн.

def cap_cwebp_to_webp_batch(in_dir="", out_dir="", quality="80") -> str:
