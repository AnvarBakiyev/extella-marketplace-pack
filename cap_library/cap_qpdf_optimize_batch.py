# expert: cap_qpdf_optimize_batch
# description: Повернуть и оптимизировать PDF — Поворот и веб-оптимизация PDF без потери качества Пакетно: операция «Оптимизировать для веба» ко всем подходящим файлам в папке. Локально/офлайн.

def cap_qpdf_optimize_batch(in_dir="", out_dir="", _pad=None) -> str:
    ...
    for src in srcs:
        ...
        dst = os.path.join(out_dir, stem + "_web.pdf")
