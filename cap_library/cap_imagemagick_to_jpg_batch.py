# expert: cap_imagemagick_to_jpg_batch
# description: Пакет картинок — Размер и формат тысяч изображений разом — локально Пакетно: операция «В JPG» ко всем подходящим файлам в папке. Локально/офлайн.

def cap_imagemagick_to_jpg_batch(in_dir="", out_dir="", _pad=None) -> str:
