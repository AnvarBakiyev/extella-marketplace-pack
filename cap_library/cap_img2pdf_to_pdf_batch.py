# expert: cap_img2pdf_to_pdf_batch
# description: Картинки → PDF — Собрать PDF из картинок и сканов — локально Пакетно: операция «Картинка → PDF» ко всем подходящим файлам в папке. Локально/офлайн.

def cap_img2pdf_to_pdf_batch(in_dir="", out_dir="", _pad=None) -> str:
