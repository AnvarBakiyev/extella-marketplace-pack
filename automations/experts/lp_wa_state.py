# expert: lp_wa_state
# description: Contract agent: check GreenAPI WhatsApp instance state (authorized / notAuthorized). Params: id_instance, api_token_instance (fallback: greenapi_id/greenapi_token in ~/extella_wizard/app/config.json).
