# expert: ta_wa_state
# description: Travel Agency pack: check GreenAPI WhatsApp instance state (authorized / notAuthorized). Params: id_instance, api_token_instance (fallback: greenapi_id/greenapi_token in the current device's platform-native Extella account config).
