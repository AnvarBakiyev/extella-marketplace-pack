# expert: cap_calibre_to_epub_batch
# description: Конвертер книг — EPUB, MOBI, PDF, FB2 — конвертация электронных книг, локально Пакетно: операция «В EPUB» ко всем подходящим файлам в папке. Локально/офлайн.

def cap_calibre_to_epub_batch(in_dir="", out_dir="", _pad=None) -> str:
    ...
    pass
    srcs = sorted(glob.glob(os.path.join(in_dir, "*.mobi")))
