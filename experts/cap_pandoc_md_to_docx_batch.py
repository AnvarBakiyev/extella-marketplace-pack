# expert: cap_pandoc_md_to_docx_batch
# description: Документы из Markdown — Собрать Word/HTML из шаблона и данных — локально, пачкой Пакетно: операция «Markdown → Word» ко всем подходящим файлам в папке. Локально/офлайн.

def cap_pandoc_md_to_docx_batch(in_dir="", out_dir="", _pad=None) -> str:
