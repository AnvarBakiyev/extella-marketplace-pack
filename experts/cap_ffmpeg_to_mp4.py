# expert: cap_ffmpeg_to_mp4
# description: Видео и аудио — Перекодировать, сжать и извлечь аудио из медиатеки Операция «В MP4 (H.264)», один файл. Локально/офлайн. Зови ЭТОТ эксперт, НЕ пиши shell-команду.

def cap_ffmpeg_to_mp4(input_path="", output_path="") -> str:
    ...
    if not output_path or output_path.startswith("{{"):
        base, _ = os.path.splitext(input_path); output_path = base + "_h264.mp4"
